...
export const addItemToLSCart = (item: CartItem): CartItem[] => {
...
export const updateItemQuantityInLSCart = (productId: string, quantity: number): CartItem[] => {
  const currentCart = getCart();
...
export const removeItemFromLSCart = (productId: string): CartItem[] => {
  const currentCart = getCart();
